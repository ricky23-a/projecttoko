...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $total = $jumlah * $menu['harga_jual'];
    $tanggal = date('Y-m-d');

    // Simpan transaksi (pastikan kolom alamat_pengirim sudah ada di tabel)
    $stmt = $pdo->prepare("INSERT INTO tb_transaksi (id_menu, jumlah, total, tanggal, alamat_pengirim) VALUES (?, ?, ?, ?, ?)");
    $stmt->execute([$menu['id_menu'], $jumlah, $total, $tanggal, $alamat_pengirim]);
...
<head>
    <meta charset="UTF-8">
    <title>Transaksi Coffe Aroma Senja</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
<div class="container mt-5 pt-5">
    <h2 class="mb-4">Transaksi Coffe</h2>
    <div class="card">
        <div class="card-body">
            <!-- Gambar di atas nama menu -->
            ...
            <p class="card-text">Harga: Rp<?= number_format($menu['harga_jual'], 0, ',', '.'); ?> /menu</p>
            <form method="POST">
                <div class="mb-3">
